#add 10000000000000 to prize

button_cost = {'A':3, 'B':1}
total_cost = 0
addit = 10000000000000
...
with open("input.txt") as f:
    ...
    for line in f:
        ...
        if "Prize" in line:
            ...
            machine_result = calc_the_thing(button_A, button_B, (prize[0] + addit, prize[1] + addit))
            if machine_result:
...
print(f"De laagste kosten voor part 2 zijn: {total_cost}")
